...
## Purpose
A storage facility for the [research clusters](../slurm.md). User files are now served from [Alderaan](alderaan.md) storage nodes, and this storage facility is now used for backup.
## Hardware
