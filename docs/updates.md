...
* Node **math-alderaan-h01** was upgraded to CUDA 12.9 with NVIDIA drivers  575.x. The node is available temporarily in partion **math-alderaan-gpu-cuda12** with maximum runtime 1 day. Singularity containers with CUDA 11 should still work with **singularity exec --nv**. Testing reports welcome. 
