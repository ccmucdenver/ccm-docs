...
* Cooling temperature monitoring were improved. **All Alderaan nodes can be used at 100% 
load safely.** Reducing the number of cores used has only a limited effect anyway, because the remaining 
